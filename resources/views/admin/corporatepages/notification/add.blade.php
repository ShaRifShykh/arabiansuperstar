    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Add Notification Slider </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Add Notification Slider</h3>
                        </div>
                        <!-- /.card-header -->

                        <!-- form start -->
                        <form role="form" action="{{ route('admin.sliders.notification.insert') }}"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="key" id="key" class="form-control" required>
                                        <option value="notification_left">Notification Left Slider</option>
                                        <option value="notification_right">Notification Right Slider</option>
                                    </select>
                                </div>
                                <div class="form-group">
