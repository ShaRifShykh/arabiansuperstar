    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Edit Comment Slider </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit Comment Slider</h3>
                        </div>
                        <!-- /.card-header -->

                        <!-- form start -->
                        <form role="form" action="{{ route('admin.sliders.comment.update', ["id" => $slider->id]) }}"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="key" id="key" class="form-control" required>
                                        <option {{ $slider->key == "comment_left" ? "selected" : null }} value="comment_left">Comment Left Slider</option>
                                        <option {{ $slider->key == "comment_right" ? "selected" : null }} value="comment_right">Comment Right Slider</option>
                                    </select>
                                </div>
                                <div class="form-group">
