    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Add Home Slider </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container-fluid row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <form role="form" action="{{ route('admin.sliders.profile.insert') }}"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="key" id="key" class="form-control" required>
                                        <option value="profile_left">Profile Left Slider</option>
                                        <option value="profile_right">Profile Right Slider</option>
                                    </select>
                                </div>
                                <div class="form-group">
