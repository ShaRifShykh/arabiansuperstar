    ...
    <div class="content-wrapper" style="margin-left:0px !important">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Search Sliders</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-12 d-flex my-3 justify-content-start">
                                        <div>
                                            <a href="{{ route('admin.sliders.search.add') }}"
                                               class="btn btn-custom btn-small">Add new Search Slider</a>
                                        </div>
                                    </div>
                                            ...
                                            <table id="example1"
                                                ...
                                                @foreach($sliders as $key => $slider)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>{{ $slider->key == "search_left" ? "Search Left Slide" : "Search Right Slider"  }}</td>
                                                        <td>
                                                            <img
