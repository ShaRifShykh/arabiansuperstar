    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Edit Associate </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <section class="content">
            ...
            <div class="container-fluid row">
                ...
                <div class="col-md-6">
                    ...
                    <!-- form start -->
                        <form role="form" action="{{ route('admin.associates.update', ['id' => $associate->id]) }}"
                              method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="heading">Heading</label>
                                    <input value="{{ $associate->heading }}" type="text" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description"
                                              name="description">{{ $associate->description }}</textarea>
                                </div>
