...
@section("title", $user->full_name . "'s Profile | ")
            ...
            <div class="col-xl-6 col-lg-6 mt-5 mb-5 scrollContainer" style="height: 800px">
                <div class="row justify-content-between">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-sm-4">
                        <img style="width: 280px; height: 280px; object-fit: cover; object-position: top;"
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8">
                        <div class="row text-center align-items-center">
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-3 col-xs-6 col-6 mt-3">
                                ...
                                @if(\Illuminate\Support\Facades\Auth::guard("web")->check())
                                    @if($voting->block === 0 && \Illuminate\Support\Facades\Auth::guard("web")->user()->userAction->voting === 0)
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-xs-5 col-5 align-content-start">
