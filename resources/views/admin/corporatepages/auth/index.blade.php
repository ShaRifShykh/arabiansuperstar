    ...
    <div class="content-wrapper" style="margin-left:0px !important">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Login/Signup Sliders</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-12 d-flex my-3 justify-content-start">
                                        <div>
                                            <a href="{{ route('admin.sliders.auth.add') }}"
                                               class="btn btn-custom btn-small">Add new Login/Signup Slider</a>
                                        </div>
                                    </div>
                                            ...
                                            <table id="example1"
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="example1"
                                                        rowspan="1" colspan="1">
                                                        Image <span style="font-size: 12px; color: grey">(1280x850)</span>
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="example1"
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <a class="btn btn-small btn-custom"
                                                               href="{{ route('admin.sliders.auth.edit', ["id" => $slider->id]) }}">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </a>
                                                            <a class="btn btn-small btn-custom"
                                                               href="{{ route('admin.sliders.auth.delete', ["id" => $slider->id]) }}">
