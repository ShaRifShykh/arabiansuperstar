                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-12 d-flex my-3 justify-content-start">
                                        <div>
                                            <a href="{{ route('admin.sliders.profile.add') }}"
                                               class="btn btn-custom btn-small">Add new Home Slider</a>
                                        </div>
                                    </div>
                                            ...
                                            <table id="example1"
                                                ...
                                                @foreach($sliders as $key => $slider)
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>{{ $slider->key == "profile_left" ? "Profile Left Slide" : "Profile Right Slider"  }}</td>
                                                        <td>
                                                            <img
