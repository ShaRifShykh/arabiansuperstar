        ...
        <div class="container">
            <div class="row">
                <div class="text-white col-lg-12 col-md-12 col-sm-12 text-center ">
                    <h1 class="fw-bolder">{{ $data->heading ? strtoupper($data->heading) : 'ASSOCIATION WITH ARABIAN SUPERSTAR'}}</h1>
                    @if($data->sub_heading)
                        <p class="text-white">{!! $data->sub_heading !!}</p>
                    @else
                        <p>We Welcome All The Professionals And Amateurs To Lend Their Expertise.</p>
                        <br>
                        <p>You Will Be Featured On Our Website.</p>
                        <p>You Will Be Recognized And Announced During The Event.</p>
                    @endif
                </div>
            </div>
        </div>
